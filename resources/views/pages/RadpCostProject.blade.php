...
<h1>Add RADP Cost Information</h1>

<form action="AfterAddingFinance.php" method="post">
<table>
...
<tr>
    <td>RADP Cost</td>
    <td><input type="number" name="radpCost" min="0"  step="0.01" pattern="\d+(\.\d{2})?"required/></td>
</tr>
